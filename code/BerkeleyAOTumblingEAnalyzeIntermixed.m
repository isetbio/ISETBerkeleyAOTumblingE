...
%% Tables
Traw = table(theShifts'/2, ...
    grandMeanPCorrectPar{1}',grandMeanPCorrectPar{2}',grandMeanPCorrectPar{3}', ...
    grandMeanPCorrectPerp{1}',grandMeanPCorrectPerp{2}',grandMeanPCorrectPerp{3}', ...
    grandMeanPCorrect{1}', grandMeanPCorrect{2}', grandMeanPCorrect{3}', ...
    semMeanPCorrectPar{1}',semMeanPCorrectPar{2}',semMeanPCorrectPar{3}', ...
    semMeanPCorrectPerp{1}',semMeanPCorrectPerp{2}',semMeanPCorrectPerp{3}', ...
    'VariableNames',{'Shift', ...
    'Par No Filter', 'Par Photocurrent', 'Par Watson', ...
    'Perp No Filter', 'Perp Photocurrent', 'Perp Watson', ...
    'Par+Perp No Filter', 'Par+Perp Photocurrent', 'Par+Perp Watson', ...
    'SEM Par No Filter', 'SEM Par Photocurrent', 'SEM Par Watson', ...
    'SEM Perp No Filter', 'SEM Perp Photocurrent', 'SEM Perp Watson'});
writetable(Traw,fullfile(options.rootPath,figsDir,[calcName '_tableRaw.xls']),'WriteVariableNames',true);  

Tnormalized = table(theShifts'/2, ...
    grandMeanPCorrectPar{1}'/grandMeanPCorrectPar{1}(index0), ...
    grandMeanPCorrectPar{2}'/grandMeanPCorrectPar{2}(index0), ...
    grandMeanPCorrectPar{3}'/grandMeanPCorrectPar{3}(index0), ...
    grandMeanPCorrectPerp{1}'/grandMeanPCorrectPerp{1}(index0), ...
    grandMeanPCorrectPerp{2}'/grandMeanPCorrectPerp{2}(index0), ...
    grandMeanPCorrectPerp{3}'/grandMeanPCorrectPerp{3}(index0), ...
    semMeanPCorrectPar{1}'/grandMeanPCorrectPar{1}(index0), ...
    semMeanPCorrectPar{2}'/grandMeanPCorrectPar{2}(index0), ...
    semMeanPCorrectPar{3}'/grandMeanPCorrectPar{3}(index0), ...
    semMeanPCorrectPerp{1}'/grandMeanPCorrectPerp{1}(index0), ...
    semMeanPCorrectPerp{2}'/grandMeanPCorrectPerp{2}(index0), ...
    semMeanPCorrectPerp{3}'/grandMeanPCorrectPerp{3}(index0), ...
    'VariableNames',{'Shift', ...
    'Par No Filter', 'Par Photocurrent', 'Par Watson', ...
    'Perp No Filter', 'Perp Photocurrent', 'Perp Watson', ...
    'SEM Par No Filter', 'SEM Par Photocurrent', 'SEM Par Watson', ...
    'SEM Perp No Filter', 'SEM Perp Photocurrent', 'SEM Perp Watson'});
writetable(Tnormalized,fullfile(options.rootPath,figsDir,[calcName '_tableNormalized.xls']),'WriteVariableNames',true); 

Terror = table(theShifts'/2, ...
    grandMeanPlotErrorPar{1}',grandMeanPlotErrorPar{2}',grandMeanPlotErrorPar{3}', ...
    grandMeanPlotErrorPerp{1}',grandMeanPlotErrorPerp{2}',grandMeanPlotErrorPerp{3}', ...
    semMeanPlotErrorPar{1}',semMeanPlotErrorPar{2}',semMeanPlotErrorPar{3}', ...
    semMeanPlotErrorPerp{1}',semMeanPlotErrorPerp{2}',semMeanPlotErrorPerp{3}', ...
    'VariableNames',{'Shift', ...
    'Par No Filter', 'Par Photocurrent', 'Par Watson', ...
    'Perp No Filter', 'Perp Photocurrent', 'Perp Watson', ...
    'SEM Par No Filter', 'SEM Par Photocurrent', 'SEM Par Watson', ...
    'SEM Perp No Filter', 'SEM Perp Photocurrent', 'SEM Perp Watson'});
writetable(Terror,fullfile(options.rootPath,figsDir,[calcName '_errorNormalized.xls']),'WriteVariableNames',true);  
