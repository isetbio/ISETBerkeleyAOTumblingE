...
maxVisualizedNoisyResponseInstances = 4;
...
if (~exist(options.outputFiguresDir,'dir'))
 ...
 t_spatialCSF('fastParameters',false, ...
...
if (~exist(options.outputFiguresDir,'dir'))
 ...
 %% Photocurrent: name of this one
options.calcName = '0Hz_500ms_duration_500ms_stim_photocurrent_nofem';
...
%% Photocurrent: name of this one
options.calcName = '0Hz_500ms_duration_500ms_stim_photocurrent_withfem';
