...
for ss = 1:nShifts
    for rr = 1:nReplications
        ...
        for ff = 1:nFilterModels
            ...
            fprintf('%s\n',fileSuffix);
            [logThreshold(ss,rr,ff), logMAR(ss,rr,ff), questObj{ss,rr,ff}, psychometricFunction{ss,rr,ff}, fittedPsychometricParams{ss,rr,ff}, ...
                trialByTrialStimulusAlternatives{ss,rr,ff},trialByTrialPerformance{ss,rr,ff},theNeuralEngine{ss,rr,ff}] = ...
